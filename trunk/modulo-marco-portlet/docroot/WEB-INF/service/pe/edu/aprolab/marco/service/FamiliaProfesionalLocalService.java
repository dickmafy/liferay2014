...
/**
 * Provides the local service interface for FamiliaProfesional. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Diego
 * @see FamiliaProfesionalLocalServiceUtil
...
public interface FamiliaProfesionalLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FamiliaProfesionalLocalServiceUtil} to access the familia profesional local service. Add custom service methods to {@link pe.edu.aprolab.marco.service.impl.FamiliaProfesionalLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
