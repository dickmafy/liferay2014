...
import pe.edu.aprolab.base.NoSuchLocalException;
import pe.edu.aprolab.base.model.Local;
import pe.edu.aprolab.base.model.impl.LocalImpl;
import pe.edu.aprolab.base.model.impl.LocalModelImpl;
...
public class LocalPersistenceImpl extends BasePersistenceImpl<Local>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NOMBRE = new FinderPath(LocalModelImpl.ENTITY_CACHE_ENABLED,
			LocalModelImpl.FINDER_CACHE_ENABLED, LocalImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_NOMBRE = new FinderPath(LocalModelImpl.ENTITY_CACHE_ENABLED,
			LocalModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Local> findByNombre(String nombre) throws SystemException {
	 ...
	 */
	@Override
	public List<Local> findByNombre(String nombre, int start, int end)
	 ...
	 */
	@Override
	public Local findByNombre_First(String nombre,
		OrderByComparator orderByComparator)
		throws NoSuchLocalException, SystemException {
		Local local = fetchByNombre_First(nombre, orderByComparator);
	 ...
	 */
	@Override
	public Local fetchByNombre_First(String nombre,
		OrderByComparator orderByComparator) throws SystemException {
		List<Local> list = findByNombre(nombre, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Local findByNombre_Last(String nombre,
		OrderByComparator orderByComparator)
		throws NoSuchLocalException, SystemException {
		Local local = fetchByNombre_Last(nombre, orderByComparator);
	 ...
	 */
	@Override
	public Local fetchByNombre_Last(String nombre,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Local> list = findByNombre(nombre, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Local[] findByNombre_PrevAndNext(long localId, String nombre,
		OrderByComparator orderByComparator)
		throws NoSuchLocalException, SystemException {
		...
		try {
			...
			array[0] = getByNombre_PrevAndNext(session, local, nombre,
					orderByComparator, true);

			array[1] = local;

			array[2] = getByNombre_PrevAndNext(session, local, nombre,
	...
	protected Local getByNombre_PrevAndNext(Session session, Local local,
	...
	public void removeByNombre(String nombre) throws SystemException {
		for (Local local : findByNombre(nombre, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_NOMBRE_NOMBRE_1 = "local.nombre IS NULL";
	private static final String _FINDER_COLUMN_NOMBRE_NOMBRE_2 = "local.nombre = ?";
	private static final String _FINDER_COLUMN_NOMBRE_NOMBRE_3 = "(local.nombre IS NULL OR local.nombre = '')";
	...
	@Override
	public Local updateImpl(pe.edu.aprolab.base.model.Local local)
		throws SystemException {
		local = toUnwrappedModel(local);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.pe.edu.aprolab.base.model.Local")));
