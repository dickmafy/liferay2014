...
/**
 * The persistence utility for the formacion service. This utility wraps {@link FormacionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class FormacionUtil {
	 ...
	 */
	public static void clearCache(Formacion formacion) {
		getPersistence().clearCache(formacion);
	}
	 ...
	 */
	public static List<Formacion> findWithDynamicQuery(
	 ...
	 */
	public static Formacion update(Formacion formacion)
		throws SystemException {
		return getPersistence().update(formacion);
	}
	...
	public static Formacion update(Formacion formacion,
		...
		return getPersistence().update(formacion, serviceContext);
	}
	...
	*/
	public static java.util.List<pe.edu.aprolab.base.model.Formacion> findByCompanyId(
		long companyId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion findByCompanyId_First(
		long companyId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion fetchByCompanyId_First(
		long companyId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion findByCompanyId_Last(
		long companyId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			pe.edu.aprolab.base.NoSuchFormacionException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion fetchByCompanyId_Last(
		long companyId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion[] findByCompanyId_PrevAndNext(
		long formacionId, long companyId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			pe.edu.aprolab.base.NoSuchFormacionException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(formacionId, companyId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(formacion);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(formacions);
	}
	...
	*/
	public static pe.edu.aprolab.base.model.Formacion create(long formacionId) {
		return getPersistence().create(formacionId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion remove(long formacionId)
		throws com.liferay.portal.kernel.exception.SystemException,
			pe.edu.aprolab.base.NoSuchFormacionException {
		return getPersistence().remove(formacionId);
	}

	public static pe.edu.aprolab.base.model.Formacion updateImpl(
		pe.edu.aprolab.base.model.Formacion formacion)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(formacion);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion findByPrimaryKey(
		long formacionId)
		throws com.liferay.portal.kernel.exception.SystemException,
			pe.edu.aprolab.base.NoSuchFormacionException {
		return getPersistence().findByPrimaryKey(formacionId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static pe.edu.aprolab.base.model.Formacion fetchByPrimaryKey(
		long formacionId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(formacionId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<pe.edu.aprolab.base.model.Formacion> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FormacionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FormacionPersistence)PortletBeanLocatorUtil.locate(pe.edu.aprolab.base.service.ClpSerializer.getServletContextName(),
					FormacionPersistence.class.getName());

			ReferenceRegistry.registerReference(FormacionUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FormacionPersistence persistence) {
	}

	private static FormacionPersistence _persistence;
}