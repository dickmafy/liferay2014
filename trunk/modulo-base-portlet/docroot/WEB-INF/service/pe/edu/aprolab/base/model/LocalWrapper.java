...
public class LocalWrapper implements Local, ModelWrapper<Local> {
	...
	*/
	...
	@Override
	public int compareTo(pe.edu.aprolab.base.model.Local local) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<pe.edu.aprolab.base.model.Local> toCacheModel() {
		return _local.toCacheModel();
	}

	@Override
	public pe.edu.aprolab.base.model.Local toEscapedModel() {
		return new LocalWrapper(_local.toEscapedModel());
	}

	@Override
	public pe.edu.aprolab.base.model.Local toUnescapedModel() {
