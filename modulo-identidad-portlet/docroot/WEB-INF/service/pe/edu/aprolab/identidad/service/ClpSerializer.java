...
import pe.edu.aprolab.identidad.model.PersonaClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"modulo-identidad-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "modulo-identidad-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"pe.edu.aprolab.identidad.model.impl.PersonaImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("pe.edu.aprolab.identidad.NoSuchPersonaException")) {
			return new pe.edu.aprolab.identidad.NoSuchPersonaException();
		}
