...
public class CarreraProfesionalPersistenceImpl extends BasePersistenceImpl<CarreraProfesional>
	 ...
	 *
	 * @param carreraProfesionalorId the primary key of the current carrera profesional
	 * @param nombre the nombre
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public CarreraProfesional[] findByNombre_PrevAndNext(
		long carreraProfesionalorId, String nombre,
		OrderByComparator orderByComparator)
		throws NoSuchCarreraProfesionalException, SystemException {
		CarreraProfesional carreraProfesional = findByPrimaryKey(carreraProfesionalorId);
	 ...
	 */
	@Override
	public CarreraProfesional create(long carreraProfesionalorId) {
		CarreraProfesional carreraProfesional = new CarreraProfesionalImpl();

		carreraProfesional.setNew(true);
		carreraProfesional.setPrimaryKey(carreraProfesionalorId);
	 ...
	 */
	@Override
	public CarreraProfesional remove(long carreraProfesionalorId)
		throws NoSuchCarreraProfesionalException, SystemException {
		return remove((Serializable)carreraProfesionalorId);
	}
	...
	protected CarreraProfesional toUnwrappedModel(
		...
		carreraProfesionalImpl.setCarreraProfesionalorId(carreraProfesional.getCarreraProfesionalorId());
	 ...
	 */
	@Override
	public CarreraProfesional findByPrimaryKey(long carreraProfesionalorId)
		throws NoSuchCarreraProfesionalException, SystemException {
		return findByPrimaryKey((Serializable)carreraProfesionalorId);
	}
	 ...
	 */
	@Override
	public CarreraProfesional fetchByPrimaryKey(long carreraProfesionalorId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)carreraProfesionalorId);
	}
